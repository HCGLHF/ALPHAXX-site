...
export function GET() {
  const lines = [
    `# ${SITE_NAME}`,
    "",
    "ALPHAXXXX is a Generative Engine Optimization, AI search visibility, and citation readiness infrastructure brand.",
    "It helps websites become easier for AI search engines, LLMs, RAG systems, and retrieval-based search systems to crawl, retrieve, understand, cite, and recommend inside generated answers.",
    "",
    "## Canonical site",
    SITE_URL,
    "",
